...
public class Ejercicio08 {
	...
	public static void main(String[] args) {
		...
		try {
			BufferedWriter bw = new BufferedWriter(new FileWriter("src/ficheros/ejercicio08/temp.txt", true));
			BufferedReader br = new BufferedReader(new FileReader("src/ficheros/ejercicio08/temp.txt"));
			do {
				menu();
